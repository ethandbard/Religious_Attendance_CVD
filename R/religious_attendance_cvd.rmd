...
relig_heart_tbl <- tbl_regression(religion_heart, exponentiate = FALSE) %>% 
  modify_table_styling(
    columns = c(estimate, ci),
    rows = reference_row %in% TRUE,
    missing_symbol = "Ref."
...
relig_stroke_tbl <- tbl_regression(religion_stroke, exponentiate = FALSE) %>% 
  modify_table_styling(
    columns = c(estimate, ci),
    rows = reference_row %in% TRUE,
    missing_symbol = "Ref."
...
social_health_heart_tbl <- tbl_regression(social_health_heart, exponentiate = FALSE) %>% 
  modify_table_styling(
    columns = c(estimate, ci),
    rows = reference_row %in% TRUE,
    missing_symbol = "Ref."
...
social_health_stroke_tbl <- tbl_regression(social_health_stroke, exponentiate = FALSE) %>%
  modify_table_styling(
    columns = c(estimate, ci),
    rows = reference_row %in% TRUE,
    missing_symbol = "Ref."
...
social_health_rel_heart_tbl <- tbl_regression(social_health_rel_heart, exponentiate = FALSE) %>% 
  modify_table_styling(
    columns = c(estimate, ci),
    rows = reference_row %in% TRUE,
    missing_symbol = "Ref."
...
social_health_rel_stroke_tbl <- tbl_regression(social_health_rel_stroke, exponentiate = FALSE) %>% 
  modify_table_styling(
    columns = c(estimate, ci),
    rows = reference_row %in% TRUE,
    missing_symbol = "Ref."
...
tbl_merge(tbls = list(social_stroke_tbl, social_health_stroke_tbl, social_health_rel_stroke_tbl),
          tab_spanner = c("Social Determinants", "Health and Behavior", "Religious Attendance"))Methods
```