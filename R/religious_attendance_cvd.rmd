...
ggplot(data, aes(x = age)) + 
  ...
  theme_minimal() + 
  labs(title = "Age Distribution of NHANES Participants")
```
...
stroke_coefs <- tidy(stroke_model, conf.int = TRUE) %>% 
  filter(term != "(Intercept)")
```
...
ggplot(heart_coefs,
  ...
  theme_minimal() + 
  ylab("") +
  ggtitle("Heart Attack Coefficients")
```
