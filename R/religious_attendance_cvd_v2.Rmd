...
test_results <- data.frame(Metrics = c("Sensitivity", "Specificity", "F1", "Balanced Accuracy"),
           Model1f = c(test_results1f$byClass[c(1,2,7,11)]),
           Model1m = c(test_results1m$byClass[c(1,2,7,11)]),
           Model2f = c(test_results2f$byClass[c(1,2,7,11)]),
           Model2m = c(test_results2m$byClass[c(1,2,7,11)]),
           Model3f = c(test_results3f$byClass[c(1,2,7,11)]),
           Model3m = c(test_results3m$byClass[c(1,2,7,11)])) %>% 
