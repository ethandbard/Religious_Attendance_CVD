...
model4f <- glm(cvd ~ age + ethnicity + education + num_healthcare_visits + food_ran_out + fasting_glucose + difficulty_walking + difficulty_stairs,
               data = data_small4f, family = "binomial")

model4m <- glm(cvd ~ age + ethnicity + education + num_healthcare_visits + food_ran_out + fasting_glucose + difficulty_walking + difficulty_stairs,
