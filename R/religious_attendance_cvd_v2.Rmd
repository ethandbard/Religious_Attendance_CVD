...
data_small1f <- data_small1 %>% filter(gender == "Female")
data_small1m <- data_small1 %>% filter(gender == "Male")
data_small2f <- data_small2 %>% filter(gender == "Female") 
data_small2m <- data_small2 %>% filter(gender == "Male") 
data_small3f <- data_small3 %>% filter(gender == "Female") 
data_small3m <- data_small3 %>% filter(gender == "Male")
