...
data <- data %>% 
  mutate(tobacco_5_days = factor(tobacco_5_days))
...
#set to factor for vtable
data <- data %>% 
  mutate(
    DPQ010 = factor(DPQ010),
    DPQ020 = factor(DPQ020),
    DPQ030 = factor(DPQ030),
    DPQ040 = factor(DPQ040),
    DPQ050 = factor(DPQ050),
    DPQ060 = factor(DPQ060),
    DPQ070 = factor(DPQ070),
    DPQ080 = factor(DPQ080),
    DPQ090 = factor(DPQ090)
  )
...
data <- data %>% 
  mutate(emotional_support = factor(emotional_support))
...
data <- data %>% 
  mutate(congestive = factor(congestive),
         coronary = factor(coronary),
