...
data <- data %>%
  mutate(emotional_support = case_when(emotional_support == 1 ~ "Yes", emotional_support %in% c(2, 3) ~ "No", TRUE ~ NA),
         emotional_suppoert = factor(emotional_support, levels = c("Yes", "No"), labels = c("Yes", "No")))
