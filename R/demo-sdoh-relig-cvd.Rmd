...
# control + demo + risk factors
demo_risk_f <- glm(cvd ~ age + num_healthcare_visits + ethnicity + education + marital_status
                   + high_blood_pressure + cholesterol + diabetes + cigarette_use + BMI + depression, data = data_f, family = "binomial")

demo_risk_m <- glm(cvd ~ age + num_healthcare_visits + ethnicity + education + marital_status
                   + high_blood_pressure + cholesterol + diabetes + cigarette_use + BMI + depression, data = data_m, family = "binomial")
...
demo_risk_sdoh_f <- glm(cvd ~ age + num_healthcare_visits + ethnicity + education + marital_status
                   + high_blood_pressure + cholesterol + diabetes + cigarette_use + BMI + depression
                   + food_ran_out + health_insurance + home + poverty_level_category + 
                        emotional_support + health_care_access, data = data_f, family = "binomial")

demo_risk_sdoh_m <- glm(cvd ~ age + num_healthcare_visits + ethnicity + education + marital_status
                   + high_blood_pressure + cholesterol + diabetes + cigarette_use + BMI + depression
                   + food_ran_out + health_insurance + home + poverty_level_category + 
                        emotional_support + health_care_access, data = data_m, family = "binomial")
...
full_f <- glm(cvd ~ age + num_healthcare_visits + ethnicity + education + marital_status
                   + high_blood_pressure + cholesterol + diabetes + cigarette_use + BMI + depression
                   + food_ran_out + health_insurance + home + poverty_level_category + 
                        emotional_support + health_care_access
...
```{r}
blr_vif_tol(demo_risk_f) %>% 
  kable()
```


```{r}
blr_vif_tol(demo_risk_sdoh_f) %>% 
  kable()
```
...
```{r}
blr_vif_tol(demo_risk_m) %>% 
  kable()
```


```{r}
blr_vif_tol(demo_risk_sdoh_m) %>% 
  kable()
```
